...
<meta property="og:url" content="https://fusionwebz.com"/>
  ...
  return (<>
    ...
    <div className="container mx-auto flex px-5 py-12  sm:py-24 items-center justify-center flex-col">
      <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="heroimg.svg" />
      <div className="text-center lg:w-2/3 w-full">
        ...
        <div className="flex justify-center">
          <button className="inline-flex text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded text-lg" onClick={(()=>{location.href='https://wa.me/+918146097261'})}>Contact us</button>
